...
async def complete_processing(
    ...
    try:
        ...
        # 1. Shovqinni tozalash (agar kerak bo'lsa)
        ...
        # 2. Jimlikni olib tashlash (agar kerak bo'lsa)
        ...
        # 3. Segmentatsiya (agar kerak bo'lsa)
        ...
        # Agar segmentatsiya bo'lmasa, oxirgi faylni qaytarish
        return FileResponse(
            current_file,
            media_type="audio/wav",
...
async def download_file(file_id: str):
    ...
    """
    try:
        # Uploads va outputs papkalarida qidirish
...
async def delete_file(file_id: str):
    ...
    try:
        ...
        # Barcha papkalarda qidirish va o'chirish
        for directory in [UPLOAD_DIR, OUTPUT_DIR]:
            filepath = os.path.join(directory, file_id)
            if os.path.exists(filepath):
                os.remove(filepath)
